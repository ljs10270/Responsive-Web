...
public class UserReportServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(userID == null || userID.equals("")) {
			userID = "로그인하지 않은 사용자의 문의 메일 입니다.";
		}
		...
		String emailTitle = "한서대 족보 공유 사이트에서 접수된 문의 메일입니다.";
		String emailContent = "userID: " + userID +
							  "<br>제목: " + rTitle +
							  "<br>내용: " + rContent;
		...
		request.getSession().setAttribute("messageContent", "관리자에게 접수 되었습니다.");
		response.sendRedirect("index.jsp");
		return;
	}
