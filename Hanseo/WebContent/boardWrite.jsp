			...
			<table class="table table-bordered table-hover" style="text-align: center; border: 1px solid #dddddd">
				...
				<tbody>
					...
					<tr>
						...
						<td><input class="form-control" type="text" maxlength="50" name="boardTitle" placeholder="제목을 입력하세요." required>
					...
					<tr>
						...
						<td>
							...
							<option value="Cyber/OCU">Cyber/OCU</option>
							</select>
						</td>
					</tr>
					...
					<tr>
						...
						<td><textarea class="form-control" rows="10" name="boardContent" maxlength="2048" placeholder="내용을 입력하세요." required></textarea></td>
					</tr>
